...
void Mesh::clean()
{
	vkFreeMemory(VulkanContext::getInstance()->m_device,_vertexBuffer.memory,nullptr);
	vkDestroyBuffer(VulkanContext::getInstance()->m_device,_vertexBuffer.buffer,nullptr);
}
